<template>
  <article class="event">
    ...
    <form class="reserve">
      <div class="reserve_checks">
        <h4 class="reserve_checks-title">Забронировать столик</h4>

        <label class="reserve_check check check-red">
          <input type="checkbox" name="table_1" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">1 стол</span>
        </label>

        <label class="reserve_check check">
          <input type="checkbox" name="table_2" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">2 стол</span>
        </label>

        <label class="reserve_check check">
          <input type="checkbox" name="table_3" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">3 стол</span>
        </label>

        <label class="reserve_check check">
          <input type="checkbox" name="table_4" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">4 стол</span>
        </label>

        <label class="reserve_check check check-disabled">
          <input type="checkbox" name="table_5" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">5 стол</span>
        </label>
        <label class="reserve_check check">
          <input type="checkbox" name="table_6" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">6 стол</span>
        </label>
        <label class="reserve_check check check-red">
          <input type="checkbox" name="table_7" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">7 стол</span>
        </label>
        <label class="reserve_check check check-red">
          <input type="checkbox" name="table_8" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">8 стол</span>
        </label>
        <label class="reserve_check check check-red">
          <input type="checkbox" name="table_9" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">9 стол</span>
        </label>
        <label class="reserve_check check">
          <input type="checkbox" name="table_10" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">10 стол</span>
        </label>
        <label class="reserve_check check">
          <input type="checkbox" name="table_11" class="check_input"/>
          <span class="check_mark"></span>
          <span class="check_label">11 стол</span>
        </label>
      </div>
      <div class="reserve_scheme">
        <div class="reserve_scheme-container">
          <h4 class="reserve_scheme-title">Сцена</h4>
          <div class="reserve_scheme-wrapper">
            <svg
                class="scene"
                width="780"
                height="399"
              ...
              <g class="scene_table">
                <g class="scene_table-group" stroke="#1F1E1E">
              ...
              <g class="scene_table scene_table-red">
                <g class="scene__table-group" stroke="#BC3324">
      ...
      <div class="reserve_order">
        <h4 class="reserve_section-title">Ваши пригласительные билеты</h4>

        <div class="reserve_tickets-list">
          <div class="reserve_tickets">
            <div class="reserve_qty" data-caption="0 шт." data-price="1400 ₽">0 шт. | 1400 ₽</div>
            <div class="reserve_sum" data-currency="₽">0 ₽</div>
          </div>

          <div class="reserve_tickets">
            <div class="reserve_qty" data-captiob="0 шт." data-price="1250 ₽">0 шт. | 1250 ₽</div>
            <div class="reserve_sum" data-currency="₽">0 ₽</div>
          </div>
        </div>
        <div class="reserve_total" data-caption="Сумма" data-currency="₽">Сумма 0 ₽</div>

        <button type="submit" class="btn btn-red reserve_submit">Купить билеты</button>
      </div>
      <div class="reserve_legend">
        <h4 class="reserve_section-title">Стоимость пригласительного билета</h4>
        <div class="reserve_price">
          <p>1400 ₽ | 1 персона</p>
          <p>1250 ₽ | 1 персона</p>
        </div>
        <h4 class="reserve_section-title">Примечание</h4>
